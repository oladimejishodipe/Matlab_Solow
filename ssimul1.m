...
%***************************************************************************
function B = ssimul1(A) % A is matrix that contains all the pre-parameters 
   ...
   sd =.25;
   rng(sd,'v4')  % The old randn("seed",sd) not allowed on the version of my matlab
   ...
   for i = 1:T
     ...
     ysim(2,i+1)=a1*ysim(2,i) + .1*randn(1); % interate each cell in the second row with this function
